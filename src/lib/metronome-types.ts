...
export type SwingFeel = "auto" | "eighth" | "sixteenth";
...
export const SWING_FEEL_LABELS: Record<SwingFeel, string> = {
  auto: "Auto",
  eighth: "8th",
  sixteenth: "16th",
};
...
export const METRONOME_PRESETS: MetronomePreset[] = [
  ...
  {
    name: "Konnakol 3-4-5-4",
    bpm: 72,
    timeSig: [4, 4],
    swing: 0,
    pattern: pattern([
      [3, ["accent", "ghost", "ghost"]],
      [4, ["normal", "ghost", "ghost", "ghost"]],
      [5, ["normal", "ghost", "ghost", "ghost", "ghost"]],
      [4, ["normal", "ghost", "ghost", "ghost"]],
    ]),
  },
  {
    name: "Classical Ladder",
    bpm: 84,
    timeSig: [4, 4],
    swing: 0,
    pattern: pattern([
      [1, ["accent"]],
      [2, ["normal", "ghost"]],
      [3, ["normal", "ghost", "ghost"]],
      [4, ["normal", "ghost", "ghost", "ghost"]],
    ]),
  },
  {
    name: "Rock Pop Backbeat",
    bpm: 112,
    timeSig: [4, 4],
    swing: 0,
    pattern: pattern([
